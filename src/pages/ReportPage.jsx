...
export default function ReportPage() {
  ...
  // 미완료 신고 이력 확인 (이상없음 제외 — 마커에 영향 없으므로)
    ...
    if (imageFile) {
      try {
        ...
        const uploadRes = await fetch('/api/upload', {
          method: 'POST',
          headers: {
            'x-filename': `report-${Date.now()}.${fileExt}`,
            'x-content-type': imageFile.type,
    ...
    <div className="min-h-screen bg-gray-50 px-4 py-6">
      <div className="max-w-sm mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-800">보이는소화기 현황 확인</h1>
